...
describe("poiService", () => {
    ...
    describe("fetchCellTypes", () => {
        ...
        it("should respect AbortSignal", async () => {
            ...
            await expect(fetchCellTypes(["cell1", "cell2"], abortController.signal)).rejects.toThrow(
    ...
    describe("fetchCellType", () => {
        ...
        it("should include Authorization header when token exists", async () => {
            ...
            mockFetch.mockResolvedValueOnce({
                ok: true,
                status: 200,
                json: async () => ({ s2_cell: "cell1", type: "peak", center: { lat: 45, lng: 3 }, count: 1 }),
            });
        ...
        it("should respect AbortSignal", async () => {
            ...
            await expect(fetchCellType("cell1", abortController.signal)).rejects.toThrow("The user aborted a request.");
        });
    });
});
